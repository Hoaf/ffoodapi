...
namespace DataService.Models.Services
{
    ...
    public class TransactionService : BaseUnitOfWork<UnitOfWork>, ITransactionService
    {
        ...
        public Transaction CreateTransaction(TransactionPostRequest transaction)
        {
            ...
            if(walletBuyer != null)
            {
                walletBuyer.Balance -=  totalMoney;
            ...
            if(seller != null)
            {
                ...
                {
                    walletSeller.Balance += totalMoney;
            ...
            if (check)
            {
                ...
                Payment payment = createPayment(transaction.payment, transaction1.Id);
                updatePaymentInOrder(order, payment.Id);
        ...
        private Payment createPayment(String paymentname, int tid)
        {
        ...
        private void updatePaymentInOrder(Order order, int paymentId)
        {
